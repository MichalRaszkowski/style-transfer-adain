...
# 2️⃣ Weź jeden batch z dataloadera
...
# 5️⃣ Odtwórz obraz przez dekoder
with torch.no_grad():
    output = decoder(t)

# 6️⃣ Odnormalizuj przed zapisem
...
print("✅ Zapisano obrazy: content_example.jpg, style_example.jpg, stylized_example.jpg")
